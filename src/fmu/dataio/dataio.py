...
class ExportData:
    ...
    surface_fformat: ClassVar[str] = None  # "irap_binary"  # deprecated
    table_fformat: ClassVar[str] = "csv"
    dict_fformat: ClassVar[str] = None  # "json"  # deprecated
